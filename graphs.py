...
def gerar_graficos(algoritmo1, algoritmo2):
    ...
    plt.subplot(1, 3, 1)
    plt.plot(range(1, len(algoritmo1.latency_progression) + 1), algoritmo1.latency_progression, marker='o', color='blue', linestyle='-', linewidth=2, label=algoritmo1.name)
    plt.plot(range(1, len(algoritmo2.latency_progression) + 1), algoritmo2.latency_progression, marker='s', color='red', linestyle='--', linewidth=2, label=algoritmo2.name)
    ...
    plt.subplot(1, 3, 2)
    plt.plot(range(1, len(algoritmo1.seeks_progression) + 1), algoritmo1.seeks_progression, marker='o', color='blue', linestyle='-', linewidth=2, label=algoritmo1.name)
    plt.plot(range(1, len(algoritmo2.seeks_progression) + 1), algoritmo2.seeks_progression, marker='s', color='red', linestyle='--', linewidth=2, label=algoritmo2.name)
    plt.xlabel('Número de Requisições')
    ...
    plt.subplot(1, 3, 3)
    plt.plot(algoritmo1.latency_progression, algoritmo1.seeks_progression, marker='o', color='blue', linestyle='-', linewidth=2, label=algoritmo1.name)
    plt.plot(algoritmo2.latency_progression, algoritmo2.seeks_progression, marker='s', color='red', linestyle='--', linewidth=2, label=algoritmo2.name)
